...
func (m *mRecordAccessorMockForID) Return(r record.Store, r1 error) *RecordAccessorMock {
	m.mock.ForIDFunc = nil
	m.expectationSeries = nil
...
func (e *RecordAccessorMockForIDExpectation) Return(r record.Store, r1 error) {
	e.result = &RecordAccessorMockForIDResult{r, r1}
}

//Set uses given function f as a mock of RecordAccessor.ForID method
func (m *mRecordAccessorMockForID) Set(f func(p context.Context, p1 insolar.ID) (r record.Store, r1 error)) *RecordAccessorMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecordAccessorMock) ForID(p context.Context, p1 insolar.ID) (r record.Store, r1 error) {
