...
type RecordStorageMock struct {
	...
	ForIDFunc       func(p context.Context, p1 insolar.ID) (r *record.Item, r1 error)
	ForIDCounter    uint64
	ForIDPreCounter uint64
	ForIDMock       mRecordStorageMockForID

	SetFunc       func(p context.Context, p1 insolar.ID, p2 record.Item) (r error)
	SetCounter    uint64
...
func (m *mRecordStorageMockForID) Return(r *record.Item, r1 error) *RecordStorageMock {
	m.mock.ForIDFunc = nil
	m.expectationSeries = nil
...
func (e *RecordStorageMockForIDExpectation) Return(r *record.Item, r1 error) {
	e.result = &RecordStorageMockForIDResult{r, r1}
}

//Set uses given function f as a mock of RecordStorage.ForID method
func (m *mRecordStorageMockForID) Set(f func(p context.Context, p1 insolar.ID) (r *record.Item, r1 error)) *RecordStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecordStorageMock) ForID(p context.Context, p1 insolar.ID) (r *record.Item, r1 error) {
...
func (m *mRecordStorageMockSet) Expect(p context.Context, p1 insolar.ID, p2 record.Item) *mRecordStorageMockSet {
	m.mock.SetFunc = nil
	m.expectationSeries = nil
...
func (m *mRecordStorageMockSet) ExpectOnce(p context.Context, p1 insolar.ID, p2 record.Item) *RecordStorageMockSetExpectation {
	m.mock.SetFunc = nil
	m.mainExpectation = nil
...
func (m *mRecordStorageMockSet) Set(f func(p context.Context, p1 insolar.ID, p2 record.Item) (r error)) *RecordStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecordStorageMock) Set(p context.Context, p1 insolar.ID, p2 record.Item) (r error) {
