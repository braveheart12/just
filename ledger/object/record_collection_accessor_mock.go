...
type RecordCollectionAccessorMock struct {
	...
	ForPulseFunc       func(p context.Context, p1 insolar.JetID, p2 insolar.PulseNumber) (r []record.Item)
...
func (m *mRecordCollectionAccessorMockForPulse) Return(r []record.Item) *RecordCollectionAccessorMock {
	m.mock.ForPulseFunc = nil
	m.expectationSeries = nil
...
func (e *RecordCollectionAccessorMockForPulseExpectation) Return(r []record.Item) {
...
func (m *mRecordCollectionAccessorMockForPulse) Set(f func(p context.Context, p1 insolar.JetID, p2 insolar.PulseNumber) (r []record.Item)) *RecordCollectionAccessorMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecordCollectionAccessorMock) ForPulse(p context.Context, p1 insolar.JetID, p2 insolar.PulseNumber) (r []record.Item) {
